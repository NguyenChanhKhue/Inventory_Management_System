...
public class JwtUtils {
    ...
    @PostConstruct // sẽ tự động execute sau khi inject thành công 
    private void init() { // chỉ run 1 lần duy nhẩt
        byte[] keyByte = secreteJwtString.getBytes(StandardCharsets.UTF_8); 
        this.key = new SecretKeySpec(keyByte, "HmacSHA256"); // khời tạo biến 
    }
