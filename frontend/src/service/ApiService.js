...
export default class ApiService {
  ...
  // save role with encryption (mã hóa role rồi lưu vào localStorage)
  ...
  /*
    ...
    EX : url , body: data , (headers : cấu hình request gửi lên)
  ...
  */
  ...
  static isAuthenticated() {
    const token = this.getToken();
    return !!token; // ép kiểu token trả thành boolean , nếu có token trả về true
  }
